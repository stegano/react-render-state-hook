...
export interface DataHandlerExecutorInterceptor<Data extends any = any> {
    (previousData: Data | undefined, dataHandlerExecutor: DataHandlerExecutor<Data>, executorId?: string): ReturnType<typeof dataHandlerExecutor>;
}
export interface Context {
    getDataHandlerExecutorInterceptorList: <Data extends any>() => DataHandlerExecutorInterceptor<Data>[];
