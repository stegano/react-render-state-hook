 ...
 */
export type FailureRenderer<DataHandlingError extends Error | unknown = unknown, Data extends any = any> = ReactNode | ((error: DataHandlingError, previousData?: Data) => ReactNode);
export interface Render<Data = any, DataHandlingError = any> {
    (completedRenderer?: CompletedRenderer<Data>, idleRenderer?: IdleRenderer<Data>, inProgressRenderer?: InProgressRenderer<Data>, failureRenderer?: FailureRenderer<DataHandlingError, Data>): ReactNode;
}
